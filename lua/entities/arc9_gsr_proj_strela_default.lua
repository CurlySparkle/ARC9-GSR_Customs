...
ENT.Base = "arc9_gsr_proj_40mm_base"
ENT.PrintName = "Strela Rocket"
ENT.DragCoefficient = 0.25

if CLIENT then
    killicon.Add( "arc9_gsr_proj_strela_default2", "hud/killicons/default", Color( 255, 255, 255, 255 ) )
end


ENT.Model = "models/weapons/csgo/mags/w_eq_strela_rocket.mdl"
ENT.Damage = 150
ENT.Radius = 300
ENT.Gravity = false
