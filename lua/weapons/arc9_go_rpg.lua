...
SWEP.ViewModel = "models/weapons/csgo/c_eq_rpg.mdl"
...
SWEP.WorldModelMirror = "models/weapons/csgo/c_eq_rpg.mdl"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_la_rpapa7_raise_first.ogg", t = 0 / 30},
        },
    },
    ["draw"] = {
        Source = "draw_short",
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/eq_rpg_decal_a.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/eq_rpg_decal_b.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/eq_rpg_decal_c.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/eq_rpg_decal_d.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/eq_rpg_decal_e.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/eq_rpg_decal_f.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Charm",
