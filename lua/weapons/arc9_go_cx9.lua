...
SWEP.WorldModelMirror = "models/weapons/csgo/c_smg_evo.mdl"
...
SWEP.Animations = {
    ...
    ["inspect"] = {
        ...
        EventTable = {
            { s = path .. "wfoly_sm_secho_inspect_magout.wav", t = 0 / 30 },
			{ s = path .. "wfoly_sm_secho_inspect_magin.wav", t = 58 / 30 },
			{ s = path .. "wfoly_sm_secho_inspect_end.wav", t = 104 / 30 },
        },
    },
    ["bash"] = {
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/smg_cx9_decal_a.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/smg_cx9_decal_b.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/smg_cx9_decal_c.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Stickers",
        StickerModel = "models/weapons/stickers/smg_cx9_decal_d.mdl",
        Category = "stickers",
    },
    {
        PrintName = "Charm",
